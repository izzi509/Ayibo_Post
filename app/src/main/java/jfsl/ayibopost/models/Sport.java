...
public class Sport {
    ...
    public Sport (JSONObject jsonObject) throws JSONException {
    ...
    public static ArrayList<Sport> fromJSONArray(JSONArray array) {
        ArrayList<Sport> results = new ArrayList<>();

        for (int x = 0; x < array.length(); x++){
            try {
                results.add (new Sport(array.getJSONObject(x)));
